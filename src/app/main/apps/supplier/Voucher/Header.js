            ...
            <Grid item container xs={'12'} style={{ paddingBottom: '20px' }}>
              ...
              <Grid item container xs={'5'}>
                <Box>
                  ...
                  >
                    Create, sell and manage gift vouchers
                  ...
                  >
                    Allow your clients to share their love of your business. Customise vouchers to cover specific services, personalise them and share via email for that perfect gift.
                    <ul style={{ listStyle: 'bullet', padding: '17px' }}>
                      <li>Sell vouchers both in-store and online when using Fresha payments
                      </li>
                      <li>Sell vouchers both in-store and online when using Fresha payments
                      </li>
                      <li>Sell vouchers both in-store and online when using Fresha payments
