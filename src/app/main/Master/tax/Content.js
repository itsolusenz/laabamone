...
function ClientGroupTable(props) {
    ...
    const Savecat = async () => {
        ...
        console.log(str);
        fetch(
            'https://www.laabamone.com/appoint_api.php?eventtype=taxadd&' + str + '&name=' +
            Name + '&percentage=' + NamePer + '&status=' + Status + '&order=' + Orderr
    ...
    const columns1 = [
        ...
        { id: 'name', name: "name", label: 'Tax', minWidth: 170 },
        { id: 'percentage', name: "percentage", label: 'Tax Percentage', minWidth: 170 },
        {
            id: "id",
            name: "id",
            label: "",
            ...
            <div className="flex flex-col p-10 w-full ">
                ...
                <div>
                    ...
                    >
                        ...
                        <DialogTitle id="scroll-dialog-title">{t('Tax')} </DialogTitle>
                        <DialogContent >
                            <DialogContentText
                                ...
                                <Grid container spacing={1}>
                                    <Grid item xs={12} marginTop={2}>
                                        <TextField fullWidth
                                            ...
                                            label="Tax Name" variant="outlined" />
                                    </Grid>
                                    <Grid item xs={12} marginTop={2}>
                                        <TextField fullWidth
                                            value={NamePer}
                                            ...
                                            label="Tax Percentage" variant="outlined" />
                                    </Grid>
                                    <Grid item xs={12} marginTop={2}>
