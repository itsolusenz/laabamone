  ...
  return (
    ...
    <div className="flex flex-col p-10 w-full ">
      ...
      <div>
        ...
        >
          <DialogTitle id="scroll-dialog-title">Add Clientgroup</DialogTitle>
          <DialogContent >
            <DialogContentText
            ...
            >
              <Grid width={'100%'} >
                ...
                <TextField fullWidth id="standard-basic" label="Clientgroup" variant="standard" />
                ...
                <TextField fullWidth id="standard-basic" label="Order" variant="standard" />
              </Grid>
            </DialogContentText>
          </DialogContent>
          <DialogActions>
